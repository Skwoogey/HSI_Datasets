...
def createSavedTransformFile(data_file, gt_file, save_path, window_size, transformations)

image, ground_truth = loadData(data_file, gt_file)

HSI_IH = HSIImageHandler(image, ground_truth, window_size, None)
